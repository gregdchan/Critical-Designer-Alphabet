	...
	{#if currentView === 'launching'}
		<div class="flex items-center justify-center min-h-screen">
			<div class="text-center">
				<div
					class="w-16 h-16 border-4 border-cyan-400 border-t-transparent rounded-full animate-spin mx-auto mb-6"
				></div>
					...
					<div class="grid gap-3">
						{#each activeSessions as session}
							...
							>
								...
								<div class="text-cyan-400 text-sm">Enter →</div>
							</button>
						{/each}
					</div>
				{/if}
			...
			{#if currentView === 'orchestration'}
				...
				<div class="space-y-8">
					...
					<div class="grid lg:grid-cols-3 gap-6">
						<div
							class="lg:col-span-2 bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-cyan-400/20"
						>
						...
						<div
							class="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-purple-400/20"
						>
									...
									>
										<div class="flex items-center justify-between mb-2">
											<div class="flex items-center gap-3">
												<span
													class="w-8 h-8 rounded-full bg-gradient-to-r from-cyan-400 to-purple-400 text-slate-900 flex items-center justify-center text-sm font-bold"
												>
													{index + 1}
												</span>
												<div>
										...
										{#if phase.dashboards?.length}
											<div class="flex flex-wrap gap-2">
												...
												{#if phase.dashboards.length > 3}
													<span class="px-2 py-1 bg-slate-600 text-slate-300 rounded text-xs"
											...
											<div class="space-y-2">
												...
												<div class="space-y-1">
													{#each phase.dashboards as dashboard}
														<div class="text-xs px-2 py-1 bg-purple-400/20 text-purple-200 rounded">
															{dashboard}
														</div>
													{/each}
												</div>
					...
					<!-- Launch Controls -->
					<div
						class="bg-gradient-to-r from-slate-800/50 to-slate-700/50 backdrop-blur-sm rounded-xl p-6 border border-cyan-400/20"
					>
