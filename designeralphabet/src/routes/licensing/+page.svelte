...
<svelte:head>
	<title>Licensing & Attribution - Critical Designer Alphabet</title>
	<meta
		name="description"
		content="Licensing information and attribution for The Designer's Critical Alphabet workshop platform."
	/>
</svelte:head>
...
<div class="space-y-12">
	...
	<section class="bg-slate-800 rounded-lg border border-slate-600 p-8">
		<div class="flex items-start gap-4 mb-6">
			<div
				class="flex h-12 w-12 items-center justify-center rounded-lg bg-purple-600/20 text-purple-400"
			>
				<Users class="h-6 w-6" />
			</div>
			<div>
	...
	<section class="bg-slate-800 rounded-lg border border-slate-600 p-8">
		<div class="flex items-start gap-4 mb-6">
			<div
				class="flex h-12 w-12 items-center justify-center rounded-lg bg-green-600/20 text-green-400"
			>
				<Heart class="h-6 w-6" />
			</div>
			<div>
	...
	<!-- Acknowledgements -->
	<section
		class="bg-gradient-to-r from-blue-900/20 to-purple-900/20 border border-slate-600 rounded-lg p-8"
	>
